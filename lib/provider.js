...
_write(chunk, encoding, callback) {
    // Convert the incoming chunk to MP3 format using ffmpeg
    ffmpeg(chunk)
        .toFormat('mp3')
        .on('error', (err) => {
        ...
        .pipe(stream => {
            ...
            formData.append('file', stream, {
                filename: 'audio.mp3',
                contentType: 'audio/mpeg', // Make sure this matches your API's expected content type
            });

            // Send the form data to your custom API
            ...
            .then((response) => {
                // Handle the response from your custom API here
