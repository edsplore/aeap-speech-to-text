...
class CustomProvider extends Writable {
    constructor(options) {
        ...
        this.timer = null;
        this.isActive = false;
        this.MAX_BUFFER_SIZE = options.maxBufferSize || 10240; // 10 KB buffer size for testing
    ...
    convertAndSendData() {
        ...
        const tempPath = '/path/to/temp_audio.raw';
        const outputPath = '/path/to/output_audio.wav';
