...
class CustomProvider extends Writable {
    constructor(options) {
        super(options);
        this.ngrokUrl = options.ngrokUrl || 'https://3493-49-36-184-150.ngrok-free.app/transcribe';
        this.buffer = [];
        this.bufferSize = 0;
        this.timer = null;
        this.isActive = false;
        this.isFinalizing = false;
        this.MAX_BUFFER_SIZE = options.maxBufferSize || 1024000;
        this.MAX_TIME_THRESHOLD = options.maxTimeThreshold || 500000;
    }
